...
관련 문서: [[인증 8-9단계 — Keycloak BFF 자체-JWT 플랫폼 (구현 기록)]], [[인증 10단계 — keycloakify MUI 로그인 테마 (구현 기록)]], [[인증 11단계 — 로그아웃 백채널 수정 (구현 기록)]], [[인증 6-7단계 — OAuth2-OIDC 로그인]]
...
### 3-4. 백채널 로그아웃 ([[인증 11단계 — 로그아웃 백채널 수정 (구현 기록)|상세 기록]])
